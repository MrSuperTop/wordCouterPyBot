...
''',
    ...
    'stg': dotdict({
      'msgTitle': 'Here you can set your settings.\nTo change setting\'s value have to press the correct button and then you should go to the chat with bot, you can do it using the last button.',
      'valueSet': 'Value set!',
      ...
      'valueIsWrong': 'New value doesn\'t match the requirments...\nPlease, try again...',
    ...
    'goToBot': [
      'Click here to go to the bot\'s chat',
...
''',
    ...
    'stg': dotdict({
      'msgTitle': 'Тут можно выбрать настройки.\nЧто бы изменить начение настройки нужно нажать правильную кнопку и потом перейти в чат с ботом, это можно сделать нажав на последнюю кнопку.',
      'valueSet': 'Значение установлено!',
      'editButtonValue': 'Изменить значения настрек ⚙.',
      'moreInfoButtonValue': 'Чтобы получить дополнительную информацию нажмите сюда 📰.',
      ...
      'valueIsWrong': 'Новое значение не удовлетворяет критерии...Пожалуйста, попробуйте ещё раз',
    ...
    'goToBot': [
      'Нажмите сюда, чтобы перейти в чат с ботом',
      'Нажмите, чтобы увидеть статистику'
    ],
    'goToChat': [
      'Вернутся назад в чат'
    ]
  })
})
